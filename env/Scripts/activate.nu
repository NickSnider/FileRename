...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Snider\PycharmProjects\FileRename\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Snider\PycharmProjects\FileRename\env\Scripts\deactivate.nu'
